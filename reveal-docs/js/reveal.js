...
//     .append("h1")
//   	.attr("id", "title_text")
//     .text("recently, the Fed raised rates to 1.75%.");
...
// 		// If they haven't begun story, go back.
// 		if (count ==0){
// 			return true;
// 		}	
// 		// If they are in story and want to go 
// 		// back in story
...
//     console.log('called slide listener')
//     console.log(slideState);
// 	if (slideState == 'employment'){
...
(function( root, factory ) {
	...
	var SLIDES_SELECTOR = '.slides section',
		...
		config = {
			...
			keyboardCondition: null, //slideListener,
